...
async def test_stream_vision_response(openai_instance):
    ...
    response = openai_instance.stream_vision_response(b"fake_image_data", "Describe this image", "image/jpeg")
    result = list(response)
...
def test_resolve_model(openai_instance):
    ...
    assert openai_instance.resolve_model("gpt-4-vision-preview") == "gpt-4-vision-preview"